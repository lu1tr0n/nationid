...
const VALID_SAMPLES: Readonly<Record<DocumentTypeCode, ReadonlyArray<string>>> = {
  ...
  // v0.6.0 — 36 European specs across 12 countries (brute-force).
  GB_NINO: generateBruteForceValid("GB_NINO", VALID_SAMPLES_PER_CODE),
  GB_UTR: generateBruteForceValid("GB_UTR", VALID_SAMPLES_PER_CODE),
  GB_VAT: generateBruteForceValid("GB_VAT", VALID_SAMPLES_PER_CODE),
  GB_NHS: generateBruteForceValid("GB_NHS", VALID_SAMPLES_PER_CODE),
  FR_NIR: generateBruteForceValid("FR_NIR", VALID_SAMPLES_PER_CODE),
  FR_SIREN: generateBruteForceValid("FR_SIREN", VALID_SAMPLES_PER_CODE),
  FR_SIRET: generateBruteForceValid("FR_SIRET", VALID_SAMPLES_PER_CODE),
  FR_TVA: generateBruteForceValid("FR_TVA", VALID_SAMPLES_PER_CODE),
  DE_STEUER_ID: generateBruteForceValid("DE_STEUER_ID", VALID_SAMPLES_PER_CODE),
  DE_STEUERNUMMER: generateBruteForceValid("DE_STEUERNUMMER", VALID_SAMPLES_PER_CODE),
  DE_USTID: generateBruteForceValid("DE_USTID", VALID_SAMPLES_PER_CODE),
  IT_CF: generateBruteForceValid("IT_CF", VALID_SAMPLES_PER_CODE),
  IT_PIVA: generateBruteForceValid("IT_PIVA", VALID_SAMPLES_PER_CODE),
  NL_BSN: generateBruteForceValid("NL_BSN", VALID_SAMPLES_PER_CODE),
  NL_BTW: generateBruteForceValid("NL_BTW", VALID_SAMPLES_PER_CODE),
  BE_NRN: generateBruteForceValid("BE_NRN", VALID_SAMPLES_PER_CODE),
  BE_BTW: generateBruteForceValid("BE_BTW", VALID_SAMPLES_PER_CODE),
  CH_AHV: generateBruteForceValid("CH_AHV", VALID_SAMPLES_PER_CODE),
  CH_UID: generateBruteForceValid("CH_UID", VALID_SAMPLES_PER_CODE),
  CH_MWST: generateBruteForceValid("CH_MWST", VALID_SAMPLES_PER_CODE),
  PL_PESEL: generateBruteForceValid("PL_PESEL", VALID_SAMPLES_PER_CODE),
  PL_NIP: generateBruteForceValid("PL_NIP", VALID_SAMPLES_PER_CODE),
  PL_REGON: generateBruteForceValid("PL_REGON", VALID_SAMPLES_PER_CODE),
  SE_PERSONNUMMER: generateBruteForceValid("SE_PERSONNUMMER", VALID_SAMPLES_PER_CODE),
  SE_ORGNR: generateBruteForceValid("SE_ORGNR", VALID_SAMPLES_PER_CODE),
  SE_VAT: generateBruteForceValid("SE_VAT", VALID_SAMPLES_PER_CODE),
  NO_FNR: generateBruteForceValid("NO_FNR", VALID_SAMPLES_PER_CODE),
  NO_DNR: generateBruteForceValid("NO_DNR", VALID_SAMPLES_PER_CODE),
  NO_ORGNR: generateBruteForceValid("NO_ORGNR", VALID_SAMPLES_PER_CODE),
  NO_MVA: generateBruteForceValid("NO_MVA", VALID_SAMPLES_PER_CODE),
  DK_CPR: generateBruteForceValid("DK_CPR", VALID_SAMPLES_PER_CODE),
  DK_CVR: generateBruteForceValid("DK_CVR", VALID_SAMPLES_PER_CODE),
  DK_VAT: generateBruteForceValid("DK_VAT", VALID_SAMPLES_PER_CODE),
